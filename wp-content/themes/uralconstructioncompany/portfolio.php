                ...
                <div class="container p-sm-0">
                  <div class="row">
                    ...
                    <div class="col-lg-7 p-0 pl-sm-3 pr-sm-3">
                      ...
                      <div id="portfolio-slider_<?php echo $sliderId; ?>" class="swiper-container">
                    ...
                    <div class="col-lg-5">
                      <div class="portfolio-block">
                        ...
                        <div class="slider-nav-block portfolio-button-block col-sm-7 col-md-10 col-lg-12 p-0">
                          <!-- Add Pagination -->
                          <div id="portfolio-pagination_<?php echo $sliderId; ?>" class="slider-pagination portfolio-pagination"></div>
                          <!-- Add Scrollbar -->
                          <div id="portfolio-scrollbar_<?php echo $sliderId; ?>" class="slider-scrollbar swiper-scrollbar"></div>
                          <!-- Add Arrows -->
                          <div class="slider-button">
                            <div id="portfolio-next_<?php echo $sliderId; ?>" class="slider-button-next portfolio-next"><svg class="bi bi-chevron-right"
                                width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                  d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                              </svg></div>
                            <div id="portfolio-prev_<?php echo $sliderId; ?>" class="slider-button-prev portfolio-prev"><svg class="bi bi-chevron-left"
                                width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
